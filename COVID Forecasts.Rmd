...
```
*This is where I think I need help understanding, I am working with a transformed version of the data that is made up of square-root values, I have also come to the conclusion that it benefits from first differencing. Am I estimating these models correctly by including a constant of 1? What does including a constant even do?*
...
```
*how do I determine how many degrees of freedom I need to include?*
...
*how do I use my model to forecast values and not square_root values?*
```{r}

```
*after reading the notes you provided I think I confused myself, I thought that spikes in the ACF coincided with the moving average, as in q & Q and the PACF vice versa, is this not correct? For example, please look at how I break down the plots starting in line 142 * 

##Forecasting with a Single-Layer Feed-Forward Nueral Network 
*Since we cannot account for seasonality in the sense of yearly trends like we did with ETS & SARIMA models using Fourier terms, would it be better to just drop the period alltogther? Or maybe include a period to try to model how the virus mutates and becomes more infectious throughout the year? (maybe it mutates every couple months? (period=60))*
